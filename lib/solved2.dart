...
class AnimatedCarousel extends StatefulWidget {
  ...
  const AnimatedCarousel({Key? key, required this.children, this.initialIndex = 0}) : super(key: key);
...
class _AnimatedCarouselState extends State<AnimatedCarousel> with TickerProviderStateMixin {
  ...
  // TODO: Infinite scroll Loop
  // TODO: CrossFade to new content
  // TODO: Use Animated Widgets with incrDx?
  ...
  void initState() {
    ...
    // dispChildren[0] = currentIndex - 1 < 0 ? const CarouselItem() : widget.children[currentIndex - 1];
    // dispChildren[1] = widget.children[currentIndex];
    // dispChildren[2] = currentIndex + 1 >= widget.children.length ? const CarouselItem() : widget.children[currentIndex + 1];
    ...
    _leftToRightItem = Tween<Offset>(
      // begin: Offset(getProporcionalWidth(-16), getProporcionalHeight(20)),
      // end: Offset(getProporcionalWidth(287), getProporcionalHeight(20)),
    ...
    _centerToLeftItem = Tween<Offset>(
      ...
      // end: Offset(getProporcionalWidth(-84), getProporcionalHeight(-16)),
